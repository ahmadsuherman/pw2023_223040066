      ...
      var r = (function () {
        ...
        g = (function () {
          function e() {
            ...
            (this.runOnce = !0),
              (this.isInputElement || this.isContentEditable) && (this.settings.noEventListeners || this._createEventListeners(), this._setReadOnly()),
              ...
              (this.global = {
                ...
                addObject: function (t) {
                  ...
                  var r = void 0;
                  s instanceof Map ? (r = d.default.mergeMaps(i._getLocalList(), s)) : (i._addToLocalList(n, a), (r = i._getLocalList())),
              ...
              (this.options = {
                reset: function () {
                  return (i.settings = { rawValue: i.defaultRawValue }), i.update(e.defaultSettings), i;
                },
                ...
                noEventListeners: function (t) {
                  return t === e.options.noEventListeners.noEvents && i.settings.noEventListeners === e.options.noEventListeners.addEvents && i._removeEventListeners(), i.update({ noEventListeners: t }), i;
                },
              ...
              this._triggerEvent(e.events.initialized, this.domElement, { newValue: d.default.getElementValue(this.domElement), newRawValue: this.rawValue, error: null, aNElement: this });
          }
          return (
            u(
              e,
              [
                ...
                },
                {
                  ...
                  value: function () {
                    if (!d.default.isNull(this.parentForm)) {
                      ...
                      1 === e
                        ? (this.parentForm.removeEventListener("submit", this._getFormHandlerFunction(), !1), this._removeFormDataSetInfo())
                        : e > 1
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules) ||
                      "" === this.rawValue ||
                      (d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.positive) || (this.rawValue >= 0 ? this._addCSSClass(this.settings.styleRules.positive) : this._removeCSSClass(this.settings.styleRules.positive)),
                      d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.negative) || (this.rawValue < 0 ? this._addCSSClass(this.settings.styleRules.negative) : this._removeCSSClass(this.settings.styleRules.negative)),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if ((d.default.isNull(i) || this._setSettings(i, !0), null === t && this.settings.emptyInputBehavior !== e.options.emptyInputBehavior.null))
                      return (
                        d.default.warning(
                    ...
                    if (((a = this.constructor._toNumericValue(t, this.settings)), isNaN(Number(a))))
                      return d.default.warning("The value you are trying to set results in `NaN`. The element value is set to the empty string instead.", this.settings.showWarnings), this.setValue("", n), this;
                    if (("" === a && this.settings.emptyInputBehavior === e.options.emptyInputBehavior.zero && (a = 0), "" !== a)) {
                      ...
                      if ((d.default.isZeroOrHasNoValue(a) && (a = "0"), l && u)) {
                        ...
                        return (
                          (c = this._trimLeadingAndTrailingZeros(c.replace(this.settings.decimalCharacter, "."))),
                          (a = this._getRawValueToFormat(a)),
                          this.isFocused
                            ? (a = this.constructor._roundFormattedValueShownOnFocus(a, this.settings))
                            : (this.settings.divisorWhenUnfocused && ((a /= this.settings.divisorWhenUnfocused), (a = a.toString())), (a = this.constructor._roundFormattedValueShownOnBlur(a, this.settings))),
                          (a = this.constructor._modifyNegativeSignAndDecimalCharacterForFormattedValue(a, this.settings)),
                          (a = this.constructor._addGroupSeparators(a, this.settings, this.isFocused, this.rawValue, c)),
                      ...
                      return (
                        l || this._triggerEvent(e.events.minRangeExceeded, this.domElement),
                        u || this._triggerEvent(e.events.maxRangeExceeded, this.domElement),
                        d.default.throwError("The value [" + a + "] being set falls outside of the minimumValue [" + this.settings.minimumValue + "] and maximumValue [" + this.settings.maximumValue + "] range set for this element"),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (this.rawValue !== t) {
                      var n = this.rawValue;
                      (this.rawValue = t),
                        !d.default.isNull(this.settings.rawValueDivisor) && 0 !== this.settings.rawValueDivisor && "" !== t && null !== t && this._isUserManuallyEditingTheValue() && (this.rawValue /= this.settings.rawValueDivisor),
                        this._triggerEvent(e.events.rawValueModified, this.domElement, { oldRawValue: n, newRawValue: this.rawValue, isPristine: this.isPristine(!0), error: null, aNElement: this }),
                  ...
                  value: function (t) {
                    ...
                    return (
                      t !== n &&
                        ...
                        (this.internalModification = !1),
                        i && this._triggerEvent(e.events.formatted, this.domElement, { oldValue: n, newValue: t, oldRawValue: this.rawValue, newRawValue: this.rawValue, isPristine: this.isPristine(!1), error: null, aNElement: this })),
                      this
                    );
                  },
                },
                  ...
                  value: function () {
                    ...
                    (this.settings.currencySymbolPlacement !== e.options.currencySymbolPlacement.prefix &&
                      (this.settings.currencySymbolPlacement !== e.options.currencySymbolPlacement.suffix ||
                        (this.settings.negativePositiveSignPlacement !== e.options.negativePositiveSignPlacement.prefix && this.settings.negativePositiveSignPlacement !== e.options.negativePositiveSignPlacement.none))) ||
                    ...
                    return (
                      -1 === a &&
                        ((a = this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix ? n.length - this.settings.currencySymbol.length : n.length),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    return (
                      d.default.isNull(t) ? (this.formUnformatLocalized(), this.form().submit(), this.formReformat()) : d.default.isFunction(t) ? t(this.formLocalized(e)) : d.default.throwError("The given callback is not a function."), this
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    this.isTrailingNegative =
                      ...
                      (this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix &&
                        (this.settings.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.left || this.settings.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.right));
                  },
                },
                {
                  key: "_setBrackets",
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    this.settings.caretPositionOnFocus !== e.options.caretPositionOnFocus.start &&
                      ...
                      (s = t.length),
                      (o = d.default.contains(t, this.settings.decimalCharacter)),
                      (this.settings.caretPositionOnFocus !== e.options.caretPositionOnFocus.decimalLeft && this.settings.caretPositionOnFocus !== e.options.caretPositionOnFocus.decimalRight) ||
                        (o ? ((r = t.indexOf(this.settings.decimalCharacter)), (l = this.settings.decimalCharacter.length)) : ((r = s), (l = 0))));
                    var u = "";
                  ...
                  value: function (t) {
                    ...
                    if (
                      ...
                      this.settings.emptyInputBehavior === e.options.emptyInputBehavior.focus &&
                        ...
                        (i = this.constructor._removeBrackets(d.default.getElementValue(this.domElement), this.settings));
                      var n = this._getRawValueToFormat(this.rawValue);
                      if ("" !== n) {
                        var a = void 0;
                        if (
                          ((a = this.isFocused ? this.constructor._roundFormattedValueShownOnFocus(n, this.settings) : this.constructor._roundFormattedValueShownOnBlur(n, this.settings)),
                          this.settings.showOnlyNumbersOnFocus === e.options.showOnlyNumbersOnFocus.onlyNumbers)
                        )
                          (this.settings.digitGroupSeparator = ""), (this.settings.currencySymbol = ""), (this.settings.suffixText = ""), (i = a.replace(".", this.settings.decimalCharacter));
                        else {
                          var s = void 0;
                      ...
                      l && (i = o),
                        ...
                        l && o === this.settings.currencySymbol && this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix && d.default.setElementSelection(t.target, 0);
                    }
                  },
                },
                {
                ...
                },
                {
                  key: "_onKeydown",
                  value: function (t) {
                    if (((this.formatted = !1), (this.isEditing = !0), !this.isFocused && this.settings.unformatOnHover && t.altKey && this.domElement === d.default.getHoveredElement()))
                    ...
                    this.eventKey === m.default.keyName.Esc &&
                      (t.preventDefault(), this.settings.isCancellable && this.rawValue !== this.savedCancellableValue && (this.set(this.savedCancellableValue), this._triggerEvent(e.events.native.input, t.target)), this.select());
                    var i = d.default.getElementValue(t.target);
                    if (
                      (this.eventKey === m.default.keyName.Enter && this.valueOnFocus !== i && (this._triggerEvent(e.events.native.change, t.target), (this.valueOnFocus = i), this.settings.isCancellable && this._saveCancellableValue()),
                      this._updateInternalProperties(t),
                      this._processNonPrintableKeysAndShortcuts(t))
                    )
                      return void (this.processed = !0);
                    (this.eventKey !== m.default.keyName.Backspace && this.eventKey !== m.default.keyName.Delete) ||
                      (this._processCharacterDeletion(),
                      (this.processed = !0),
                      this._formatValue(t),
                      (i = d.default.getElementValue(t.target)),
                      i !== this.lastVal && this.throwInput && (this._triggerEvent(e.events.native.input, t.target), t.preventDefault()),
                      (this.lastVal = i),
                      (this.throwInput = !0));
                  },
                },
                        ...
                        if (this._processCharacterInsertion()) {
                          ...
                          if (n !== this.lastVal && this.throwInput) this._triggerEvent(e.events.native.input, t.target), t.preventDefault();
                            ...
                            if (
                              ...
                              d.default.getElementSelection(t.target).start === d.default.getElementSelection(t.target).end &&
                              d.default.getElementSelection(t.target).start === n.indexOf(this.settings.decimalCharacter)
                            ) {
                    ...
                    if (
                      ...
                      (s === this.settings.currencySymbol
                        ? this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix
                          ...
                          : d.default.setElementSelection(t.target, this.settings.currencySymbol.length)
                        : this.eventKey === m.default.keyName.Tab && d.default.setElementSelection(t.target, 0, s.length),
                      (s === this.settings.suffixText || ("" === this.rawValue && "" !== this.settings.currencySymbol && "" !== this.settings.suffixText)) && d.default.setElementSelection(t.target, 0),
                  ...
                  value: function (t) {
                    ...
                    if (("mouseleave" === t.type && !this.isFocused) || "blur" === t.type) {
                      this._saveValueToPersistentStorage(),
                        this.settings.showOnlyNumbersOnFocus === e.options.showOnlyNumbersOnFocus.onlyNumbers &&
                          ((this.settings.digitGroupSeparator = this.originalDigitGroupSeparator), (this.settings.currencySymbol = this.originalCurrencySymbol), (this.settings.suffixText = this.originalSuffixText));
                      ...
                      if (
                        ("" === i ||
                          n ||
                          (o || this._triggerEvent(e.events.minRangeExceeded, this.domElement),
                          l || this._triggerEvent(e.events.maxRangeExceeded, this.domElement),
                          this.settings.valuesToStrings && this._checkValuesToStrings(i) && (this._setElementValue(this.settings.valuesToStrings[i]), (u = !0))),
                        !u)
                      ) {
                        var c = void 0;
                        (c = n || "" === i ? i : String(i)),
                          "" === i || n
                            ? "" === i && this.settings.emptyInputBehavior === e.options.emptyInputBehavior.zero && (this._setRawValue("0"), (c = this.constructor._roundValue("0", this.settings, 0)))
                            : o && l && !this.constructor._isElementValueEmptyOrOnlyTheNegativeSign(i, this.settings)
                            ? ((c = this._modifyNegativeSignAndDecimalCharacterForRawValue(c)),
                              this.settings.divisorWhenUnfocused && !d.default.isNull(c) && ((c /= this.settings.divisorWhenUnfocused), (c = c.toString())),
                              (c = this.constructor._roundFormattedValueShownOnBlur(c, this.settings)),
                              (c = this.constructor._modifyNegativeSignAndDecimalCharacterForFormattedValue(c, this.settings)))
                            : (o || this._triggerEvent(e.events.minRangeExceeded, this.domElement), l || this._triggerEvent(e.events.maxRangeExceeded, this.domElement));
                        var h = this.constructor._orderValueCurrencySymbolAndSuffixText(c, this.settings, !1);
                        this.constructor._isElementValueEmptyOrOnlyTheNegativeSign(c, this.settings) ||
                          (n && this.settings.emptyInputBehavior === e.options.emptyInputBehavior.null) ||
                          (h = this.constructor._addGroupSeparators(c, this.settings, !1, i)),
                          (h === i && "" !== i && this.settings.allowDecimalPadding !== e.options.allowDecimalPadding.never && this.settings.allowDecimalPadding !== e.options.allowDecimalPadding.floats) ||
                            (this.settings.symbolWhenUnfocused && "" !== i && null !== i && (h = "" + h + this.settings.symbolWhenUnfocused), this._setElementValue(h)),
                          h !== this.valueOnFocus && (this._triggerEvent(e.events.native.change, this.domElement), delete this.valueOnFocus);
                      }
                      this._onBlur(t);
                    }
                  },
                  ...
                  value: function (t) {
                    if ((t.preventDefault(), !(this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled))) {
                      ...
                      if (o === a.length) {
                        ...
                        return "." === u || "" === u || ("." !== u && !d.default.isNumber(u))
                          ? ((this.formatted = !0), void (this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' is not a valid paste content.")))
                      ...
                      var h = this._preparePastedText(i),
                        m = void 0;
                      if ("." !== (m = "." === h ? "." : d.default.arabicToLatinNumbers(h, !1, !1, !1)) && (!d.default.isNumber(m) || "" === m))
                        return (this.formatted = !0), void (this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' is not a valid paste content."));
                      var g = void 0,
                      ...
                      switch (this.settings.onInvalidPaste) {
                        ...
                        case e.options.onInvalidPaste.replace:
                          ...
                          (p = s !== r ? this._preparePastedText(P + w) : this._preparePastedText(a)),
                            f && (p = d.default.setRawNegativeSign(p)),
                            (g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter))),
                            v && g++,
                            (S = p.slice(0, g)),
                            (b = p.slice(g, p.length)),
                            "." === m && (d.default.contains(S, ".") && ((y = !0), (S = S.replace(".", ""))), (b = b.replace(".", "")));
                          for (
                            var O = d.default.parseStr(this.settings.minimumValue), N = d.default.parseStr(this.settings.maximumValue), E = p, k = 0, _ = S;
                            k < m.length && ((_ += m[k]), (p = _ + b), this.constructor._checkIfInRange(p, O, N));
                        ...
                        default:
                          ...
                          if (
                            ((p = s !== r ? this._preparePastedText(V + T) : this._preparePastedText(a)),
                            f && (p = d.default.setRawNegativeSign(p)),
                            (g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter))),
                            v && g++,
                            (S = p.slice(0, g)),
                      ...
                      if (!d.default.isNumber(p) || "" === p)
                        return void (this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' would result into an invalid content '" + p + "'."));
                      var L = !1,
                        D = !1;
                      try {
                        this.set(p), (L = !0);
                        ...
                        switch (this.settings.onInvalidPaste) {
                          ...
                          case e.options.onInvalidPaste.replace:
                            d.default.throwError(
                              "The pasted value '" + i + "' results in a value '" + p + "' that is outside of the minimum [" + this.settings.minimumValue + "] and maximum [" + this.settings.maximumValue + "] value range."
                            );
                          case e.options.onInvalidPaste.ignore:
                          default:
                            return;
                      ...
                      if (L)
                        switch (this.settings.onInvalidPaste) {
                          case e.options.onInvalidPaste.clamp:
                            if (D) {
                              this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix
                                ? d.default.setElementSelection(n, I.length - this.settings.currencySymbol.length)
                    ...
                    this.settings.readOnly ||
                      ...
                      (this.settings.modifyValueOnWheel &&
                        (this.settings.wheelOn === e.options.wheelOn.focus
                          ...
                          ? t.shiftKey
                            ? (t.preventDefault(), window.scrollBy(0, d.default.isNegativeStrict(String(t.deltaY)) ? -50 : 50))
                            : this.wheelAction(t)
                  ...
                  value: function (t) {
                    ...
                    if (
                      (d.default.isUndefinedOrNullOrEmpty(a)
                        ? this.settings.minimumValue > 0 || this.settings.maximumValue < 0
                      ...
                      d.default.isWheelUpEvent(t)
                        ? (s = d.default.addAndRoundToNearestAuto(s, this.settings.decimalPlacesRawValue))
                        : d.default.isWheelDownEvent(t) && (s = d.default.subtractAndRoundToNearestAuto(s, this.settings.decimalPlacesRawValue));
                  ...
                  value: function () {
                    ...
                    if ((d.default.isNull(t) ? ((n = d.default.getElementValue(this.domElement).trim()), this.domElement.setAttribute("value", n)) : (n = t), this.isInputElement || this.isContentEditable)) {
                      ...
                      if (this.domElement.hasAttribute("value") && "" !== this.domElement.getAttribute("value")) {
                        if (
                          (null !== this.settings.defaultValueOverride && this.settings.defaultValueOverride.toString() !== n) ||
                          (null === this.settings.defaultValueOverride && "" !== n && n !== this.domElement.getAttribute("value")) ||
                          ("" !== n && "hidden" === this.domElement.getAttribute("type") && !d.default.isNumber(a))
                        ) {
                          if (
                            (this.settings.saveValueToSessionStorage && (null !== this.settings.decimalPlacesShownOnFocus || this.settings.divisorWhenUnfocused) && this._setRawValue(this._getValueFromPersistentStorage()),
                            !this.settings.saveValueToSessionStorage)
                          ) {
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var s = !0;
                    return (
                      (this.eventKey !== m.default.keyName.Hyphen && this.eventKey !== m.default.keyName.Minus) || 0 !== Number(n) || (s = !1),
                      this.isTrailingNegative &&
                        ((d.default.isNegative(a, this.settings.negativeSignCharacter) && !d.default.isNegative(n, this.settings.negativeSignCharacter)) || ("" === a && d.default.isNegative(n, this.settings.negativeSignCharacter, !0))) &&
                        ((n = n.replace(this.settings.negativeSignCharacter, "")), (a = a.replace(this.settings.negativeSignCharacter, "")), (n = n.replace("-", "")), (a = a.replace("-", "")), (n = "-" + n)),
                      (n = e._stripAllNonNumberCharactersExceptCustomDecimalChar(n, this.settings, s, this.isFocused)),
                      (a = e._stripAllNonNumberCharactersExceptCustomDecimalChar(a, this.settings, !1, this.isFocused)),
                      [n, a]
                    );
                  },
                },
                {
                  ...
                  value: function (t, i) {
                    var n = !0;
                    (this.eventKey !== m.default.keyName.Hyphen && this.eventKey !== m.default.keyName.Minus) || 0 !== Number(t) || (n = !1),
                      this.isTrailingNegative &&
                      ...
                      (t = e._stripAllNonNumberCharactersExceptCustomDecimalChar(t, this.settings, n, this.isFocused)),
                      ...
                      this.settings.leadingZero !== e.options.leadingZero.deny ||
                        (this.eventKey !== m.default.keyName.num0 && this.eventKey !== m.default.keyName.numpad0) ||
                        0 !== Number(t) ||
                  ...
                  value: function (t, i) {
                    ...
                    if (h && m) {
                      ...
                      return (
                        ...
                        1 === y && "0" === o && this.settings.leadingZero === e.options.leadingZero.deny && (y = "" === l || ("0" === o && "" !== l) ? 1 : 0),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if ((e.ctrlKey || e.metaKey) && (this.eventKey === m.default.keyName.c || this.eventKey === m.default.keyName.v || this.eventKey === m.default.keyName.x))
                      return (
                        "keydown" === e.type && this._expandSelectionOnSign(),
                        (this.eventKey !== m.default.keyName.v && this.eventKey !== m.default.keyName.Insert) ||
                          ("keydown" === e.type || "keypress" === e.type ? d.default.isUndefined(this.valuePartsBeforePaste) && (this.valuePartsBeforePaste = this._getLeftAndRightPartAroundTheSelection()) : this._checkPaste()),
                        "keydown" === e.type || "keypress" === e.type || this.eventKey === m.default.keyName.c
                      );
                    ...
                    if (this.eventKey === m.default.keyName.LeftArrow || this.eventKey === m.default.keyName.RightArrow) {
                      if ("keydown" === e.type && !e.shiftKey) {
                        var t = d.default.getElementValue(this.domElement);
                        this.eventKey !== m.default.keyName.LeftArrow || (t.charAt(this.selection.start - 2) !== this.settings.digitGroupSeparator && t.charAt(this.selection.start - 2) !== this.settings.decimalCharacter)
                    ...
                    if (
                      (this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.prefix &&
                        ...
                        (this.eventKey === m.default.keyName.Backspace
                          ? ((this.caretFix = this.selection.start >= s.indexOf(this.settings.suffixText) && "" !== this.settings.suffixText),
                            "-" === s.charAt(this.selection.start - 1) ? (n = n.substring(1)) : this.selection.start <= s.length - this.settings.suffixText.length && (n = n.substring(0, n.length - 1)))
                          : ((this.caretFix = this.selection.start >= s.indexOf(this.settings.suffixText) && "" !== this.settings.suffixText),
                            this.selection.start >= s.indexOf(this.settings.currencySymbol) + this.settings.currencySymbol.length && (a = a.substring(1, a.length)),
                            d.default.isNegative(n, this.settings.negativeSignCharacter) && "-" === s.charAt(this.selection.start) && (n = n.substring(1)))),
                      this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix)
                    )
                      switch (this.settings.negativePositiveSignPlacement) {
                        case e.options.negativePositiveSignPlacement.left:
                          (this.caretFix = this.selection.start >= s.indexOf(this.settings.negativeSignCharacter) + this.settings.negativeSignCharacter.length),
                            this.eventKey === m.default.keyName.Backspace
                              ? this.selection.start === s.indexOf(this.settings.negativeSignCharacter) + this.settings.negativeSignCharacter.length && o
                                ? (n = n.substring(1))
                                : "-" !== n && (this.selection.start <= s.indexOf(this.settings.negativeSignCharacter) || !o) && (n = n.substring(0, n.length - 1))
                              : ("-" === n[0] && (a = a.substring(1)), this.selection.start === s.indexOf(this.settings.negativeSignCharacter) && o && (n = n.substring(1)));
                          break;
                        case e.options.negativePositiveSignPlacement.right:
                          (this.caretFix = this.selection.start >= s.indexOf(this.settings.negativeSignCharacter) + this.settings.negativeSignCharacter.length),
                            this.eventKey === m.default.keyName.Backspace
                              ? this.selection.start === s.indexOf(this.settings.negativeSignCharacter) + this.settings.negativeSignCharacter.length
                                ? (n = n.substring(1))
                                : "-" !== n && this.selection.start <= s.indexOf(this.settings.negativeSignCharacter) - this.settings.currencySymbol.length
                                ? (n = n.substring(0, n.length - 1))
                                : "" === n || o || (n = n.substring(0, n.length - 1))
                              : ((this.caretFix = this.selection.start >= s.indexOf(this.settings.currencySymbol) && "" !== this.settings.currencySymbol),
                                this.selection.start === s.indexOf(this.settings.negativeSignCharacter) && (n = n.substring(1)),
                                (a = a.substring(1)));
                      }
                    return [n, a];
                  },
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this._getUnformattedLeftAndRightPartAroundTheSelection(),
                      ...
                      n = t[1];
                    if (
                      (this.eventKey !== m.default.keyName.AndroidDefault && (this.throwInput = !0),
                      ...
                      return (
                        ...
                        !(!this.settings.negativeSignCharacter || !d.default.contains(n, this.settings.negativeSignCharacter)) ||
                        !!d.default.contains(i, this.settings.decimalCharacter) ||
                        n.indexOf(this.settings.decimalCharacter) > 0 ||
                        (0 === n.indexOf(this.settings.decimalCharacter) && (n = n.substr(1)), this._setValueParts(i + this.settings.decimalCharacter, n), !0)
                      );
                    if (("-" === this.eventKey || "+" === this.eventKey) && this.settings.isNegativeSignAllowed)
                      return "" === i && d.default.contains(n, "-") ? (n = n.replace("-", "")) : (i = d.default.isNegative(i, "-") ? i.replace("-", "") : "" + this.settings.negativeSignCharacter + i), this._setValueParts(i, n), !0;
                ...
                },
                {
                  ...
                  value: function (t) {
                    var i = d.default.getElementValue(this.domElement),
                      ...
                      s = a[0];
                    if (
                      ("" === this.settings.digitGroupSeparator || ("" !== this.settings.digitGroupSeparator && !d.default.contains(i, this.settings.digitGroupSeparator))) &&
                      ("" === this.settings.currencySymbol || ("" !== this.settings.currencySymbol && !d.default.contains(i, this.settings.currencySymbol)))
                    ) {
                      var o = i.split(this.settings.decimalCharacter),
                        l = r(o, 1),
                        u = l[0],
                        c = "";
                      d.default.isNegative(u, this.settings.negativeSignCharacter) && ((c = this.settings.negativeSignCharacter), (u = u.replace(this.settings.negativeSignCharacter, "")), (s = s.replace("-", ""))),
                        "" === c && u.length > this.settings.mIntPos && "0" === s.charAt(0) && (s = s.slice(1)),
                        c === this.settings.negativeSignCharacter && u.length > this.settings.mIntNeg && "0" === s.charAt(0) && (s = s.slice(1)),
                      ...
                      if (
                        ...
                        (this.eventKey === m.default.keyName.Backspace || this.eventKey === m.default.keyName.Delete) &&
                          ...
                          (((this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix && this.settings.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.left) ||
                            (this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.prefix && this.settings.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.suffix)) &&
                            (f.push(this.settings.negativeSignCharacter), (this.caretFix = "keydown" === t.type)),
                        ...
                        v.forEach(function (e, t) {
                          ...
                          this.eventKey === m.default.keyName.Backspace && "-" === this.settings.negativeSignCharacter && y.push("-"),
                          f.push(y.join("")),
                      ...
                      P
                        ? ((g = P[0].length),
                          this.settings.showPositiveSign &&
                            (0 === g && P.input.charAt(0) === this.settings.positiveSignCharacter && (g = 1 === P.input.indexOf(this.settings.currencySymbol) ? this.settings.currencySymbol.length + 1 : 1),
                            0 === g && P.input.charAt(this.settings.currencySymbol.length) === this.settings.positiveSignCharacter && (g = this.settings.currencySymbol.length + 1)),
                          ((0 === g && h.charAt(0) !== this.settings.negativeSignCharacter) || (1 === g && h.charAt(0) === this.settings.negativeSignCharacter)) &&
                            this.settings.currencySymbol &&
                            this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.prefix &&
                            (g = this.settings.currencySymbol.length + (d.default.isNegativeStrict(h, this.settings.negativeSignCharacter) ? 1 : 0)))
                        : (this.settings.currencySymbol && this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix && (g -= this.settings.currencySymbol.length),
                          this.settings.suffixText && (g -= this.settings.suffixText.length));
                    }
              ...
              [
                  ...
                  value: function (e, t, i) {
                    ...
                    return (
                      n && u && g
                        ...
                        : a && u && g
                        ? ((v = document.querySelector(e)), (y = null), (p = null))
                        : a && s && g
                        ? ((v = document.querySelector(e)), (y = null), (p = t))
                        : a && l && g
                        ? ((v = document.querySelector(e)), (y = null), (p = this._getOptionObject(t)))
                        : a && r && g
                        ? ((v = document.querySelector(e)), (y = null), (p = this.mergeOptions(t)))
                        : a && (u || c) && h
                        ? ((v = document.querySelector(e)), (y = null), (p = i))
                        : a && (u || c) && m
                        ? ((v = document.querySelector(e)), (y = null), (p = this.mergeOptions(i)))
                        : a && o && g
                        ? ((v = document.querySelector(e)), (y = t), (p = null))
                        : a && o && h
                        ? ((v = document.querySelector(e)), (y = t), (p = i))
                        : a && o && f
                        ? ((v = document.querySelector(e)), (y = t), (p = this._getOptionObject(i)))
                        : n && o && h
                        ? ((v = e), (y = t), (p = i))
                        : n && o && f
                      ...
                      d.default.isNull(v) && d.default.throwError("The selector '" + e + "' did not select any valid DOM element. Please check on which element you called AutoNumeric."),
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return (
                      d.default.isString(t)
                        ? (void 0 !== (i = e.getPredefinedOptions()[t]) && null !== i) || d.default.warning("The given pre-defined option [" + t + "] is not recognized by autoNumeric. Please check that pre-defined option name.", !0)
                        : (i = t),
                      i
                    );
                  },
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    a || d.default.isNull(n) || d.default.throwError("The 'originalOptions' parameter is invalid ; it should either be a valid option object or `null`, [" + t + "] given."),
                      d.default.isNull(t) || this._convertOldOptionsToNewOnes(t);
                    var s = void 0;
                    (s = i ? o({}, this.getDefaultConfig(), t) : t),
                      d.default.isTrueOrFalseString(s.showWarnings) ||
                        d.default.isBoolean(s.showWarnings) ||
                        d.default.throwError("The debug option 'showWarnings' is invalid ; it should be either 'false' or 'true', [" + s.showWarnings + "] given.");
                    var u = /^[0-9]+$/,
                      c = /[0-9]+/,
                      h = /^-?[0-9]+(\.?[0-9]+)?$/,
                      m = /^[0-9]+(\.?[0-9]+)?$/;
                    d.default.isTrueOrFalseString(s.allowDecimalPadding) ||
                      ...
                      s.allowDecimalPadding === e.options.allowDecimalPadding.floats ||
                      d.default.throwError("The decimal padding option 'allowDecimalPadding' is invalid ; it should either be `false`, `true` or `'floats'`, [" + s.allowDecimalPadding + "] given."),
                      (s.allowDecimalPadding !== e.options.allowDecimalPadding.never && "false" !== s.allowDecimalPadding) ||
                        (s.decimalPlaces === e.options.decimalPlaces.none && s.decimalPlacesShownOnBlur === e.options.decimalPlacesShownOnBlur.none && s.decimalPlacesShownOnFocus === e.options.decimalPlacesShownOnFocus.none) ||
                        d.default.warning(
                      ...
                      d.default.isNull(s.caretPositionOnFocus) ||
                        d.default.isInArray(s.caretPositionOnFocus, [e.options.caretPositionOnFocus.start, e.options.caretPositionOnFocus.end, e.options.caretPositionOnFocus.decimalLeft, e.options.caretPositionOnFocus.decimalRight]) ||
                        d.default.throwError("The display on empty string option 'caretPositionOnFocus' is invalid ; it should either be `null`, 'focus', 'press', 'always' or 'zero', [" + s.caretPositionOnFocus + "] given.");
                    var g = void 0;
                    (g = a ? n : this._correctCaretPositionOnFocusAndSelectOnFocusOptions(t)),
                      d.default.isNull(g) ||
                        g.caretPositionOnFocus === e.options.caretPositionOnFocus.doNoForceCaretPosition ||
                      ...
                      ]) || d.default.throwError("The thousand separator character option 'digitGroupSeparator' is invalid ; it should be ',', '.', '٬', '˙', \"'\", ' ', ' ', ' ', ' ' or empty (''), [" + s.digitGroupSeparator + "] given."),
                      d.default.isTrueOrFalseString(s.showOnlyNumbersOnFocus) ||
                        d.default.isBoolean(s.showOnlyNumbersOnFocus) ||
                        d.default.throwError("The 'showOnlyNumbersOnFocus' option is invalid ; it should be either 'false' or 'true', [" + s.showOnlyNumbersOnFocus + "] given."),
                      d.default.isInArray(s.digitalGroupSpacing, [e.options.digitalGroupSpacing.two, e.options.digitalGroupSpacing.twoScaled, e.options.digitalGroupSpacing.three, e.options.digitalGroupSpacing.four]) ||
                        (s.digitalGroupSpacing >= 2 && s.digitalGroupSpacing <= 4) ||
                        d.default.throwError("The grouping separator option for thousands 'digitalGroupSpacing' is invalid ; it should be '2', '2s', '3', or '4', [" + s.digitalGroupSpacing + "] given."),
                      ...
                      ]) || d.default.throwError("The decimal separator character option 'decimalCharacter' is invalid ; it should be '.', ',', '·', '⎖' or '٫', [" + s.decimalCharacter + "] given."),
                      ...
                      d.default.isNull(s.decimalCharacterAlternative) ||
                        ...
                        d.default.throwError("The alternate decimal separator character option 'decimalCharacterAlternative' is invalid ; it should be a string, [" + s.decimalCharacterAlternative + "] given."),
                      "" === s.currencySymbol || d.default.isString(s.currencySymbol) || d.default.throwError("The currency symbol option 'currencySymbol' is invalid ; it should be a string, [" + s.currencySymbol + "] given."),
                      d.default.isInArray(s.currencySymbolPlacement, [e.options.currencySymbolPlacement.prefix, e.options.currencySymbolPlacement.suffix]) ||
                        d.default.throwError("The placement of the currency sign option 'currencySymbolPlacement' is invalid ; it should either be 'p' (prefix) or 's' (suffix), [" + s.currencySymbolPlacement + "] given."),
                      ...
                      d.default.isTrueOrFalseString(s.showPositiveSign) ||
                        ...
                        d.default.throwError("The show positive sign option 'showPositiveSign' is invalid ; it should be either 'false' or 'true', [" + s.showPositiveSign + "] given."),
                      (!d.default.isString(s.suffixText) || ("" !== s.suffixText && (d.default.isNegative(s.suffixText, s.negativeSignCharacter) || c.test(s.suffixText)))) &&
                        d.default.throwError(
                          "The additional suffix option 'suffixText' is invalid ; it should not contains the negative sign '" + this.settings.negativeSignCharacter + "' nor any numerical characters, [" + s.suffixText + "] given."
                        ),
                      (!d.default.isString(s.negativeSignCharacter) || 1 !== s.negativeSignCharacter.length || d.default.isUndefinedOrNullOrEmpty(s.negativeSignCharacter) || c.test(s.negativeSignCharacter)) &&
                        d.default.throwError("The negative sign character option 'negativeSignCharacter' is invalid ; it should be a single character, and cannot be any numerical characters, [" + s.negativeSignCharacter + "] given."),
                      (!d.default.isString(s.positiveSignCharacter) || 1 !== s.positiveSignCharacter.length || d.default.isUndefinedOrNullOrEmpty(s.positiveSignCharacter) || c.test(s.positiveSignCharacter)) &&
                        d.default.throwError(
                      ...
                      s.negativeSignCharacter === s.positiveSignCharacter &&
                        d.default.throwError("The positive 'positiveSignCharacter' and negative 'negativeSignCharacter' sign characters cannot be identical ; [" + s.negativeSignCharacter + "] given.");
                    var f = d.default.isNull(s.negativeBracketsTypeOnBlur) ? ["", ""] : s.negativeBracketsTypeOnBlur.split(","),
                      v = r(f, 2),
                      p = v[0],
                      y = v[1];
                    (d.default.contains(s.digitGroupSeparator, s.negativeSignCharacter) ||
                      d.default.contains(s.decimalCharacter, s.negativeSignCharacter) ||
                      d.default.contains(s.decimalCharacterAlternative, s.negativeSignCharacter) ||
                      d.default.contains(p, s.negativeSignCharacter) ||
                      d.default.contains(y, s.negativeSignCharacter) ||
                      d.default.contains(s.suffixText, s.negativeSignCharacter)) &&
                      d.default.throwError(
                      ...
                      (d.default.contains(s.digitGroupSeparator, s.positiveSignCharacter) ||
                        d.default.contains(s.decimalCharacter, s.positiveSignCharacter) ||
                        d.default.contains(s.decimalCharacterAlternative, s.positiveSignCharacter) ||
                        d.default.contains(p, s.positiveSignCharacter) ||
                        d.default.contains(y, s.positiveSignCharacter) ||
                        d.default.contains(s.suffixText, s.positiveSignCharacter)) &&
                        d.default.throwError(
                      ...
                      d.default.isNull(s.overrideMinMaxLimits) ||
                        d.default.isInArray(s.overrideMinMaxLimits, [e.options.overrideMinMaxLimits.ceiling, e.options.overrideMinMaxLimits.floor, e.options.overrideMinMaxLimits.ignore]) ||
                        d.default.throwError("The override min & max limits option 'overrideMinMaxLimits' is invalid ; it should either be 'ceiling', 'floor' or 'ignore', [" + s.overrideMinMaxLimits + "] given."),
                      (d.default.isString(s.maximumValue) && h.test(s.maximumValue)) ||
                        d.default.throwError("The maximum possible value option 'maximumValue' is invalid ; it should be a string that represents a positive or negative number, [" + s.maximumValue + "] given."),
                      (d.default.isString(s.minimumValue) && h.test(s.minimumValue)) ||
                        d.default.throwError("The minimum possible value option 'minimumValue' is invalid ; it should be a string that represents a positive or negative number, [" + s.minimumValue + "] given."),
                      parseFloat(s.minimumValue) > parseFloat(s.maximumValue) &&
                        d.default.throwError("The minimum possible value option is greater than the maximum possible value option ; 'minimumValue' [" + s.minimumValue + "] should be smaller than 'maximumValue' [" + s.maximumValue + "]."),
                      (d.default.isInt(s.decimalPlaces) && s.decimalPlaces >= 0) ||
                        (d.default.isString(s.decimalPlaces) && u.test(s.decimalPlaces)) ||
                        d.default.throwError("The number of decimal places option 'decimalPlaces' is invalid ; it should be a positive integer, [" + s.decimalPlaces + "] given."),
                      d.default.isNull(s.decimalPlacesRawValue) ||
                        (d.default.isInt(s.decimalPlacesRawValue) && s.decimalPlacesRawValue >= 0) ||
                        (d.default.isString(s.decimalPlacesRawValue) && u.test(s.decimalPlacesRawValue)) ||
                        d.default.throwError("The number of decimal places for the raw value option 'decimalPlacesRawValue' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesRawValue + "] given."),
                      ...
                      d.default.isNull(s.decimalPlacesShownOnFocus) ||
                        ...
                        d.default.throwError("The number of expanded decimal places option 'decimalPlacesShownOnFocus' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesShownOnFocus + "] given."),
                      !d.default.isNull(s.decimalPlacesShownOnFocus) &&
                        Number(s.decimalPlaces) > Number(s.decimalPlacesShownOnFocus) &&
                        d.default.warning(
                      ...
                      ((d.default.isNull(s.divisorWhenUnfocused) || m.test(s.divisorWhenUnfocused)) && 0 !== s.divisorWhenUnfocused && "0" !== s.divisorWhenUnfocused && 1 !== s.divisorWhenUnfocused && "1" !== s.divisorWhenUnfocused) ||
                        d.default.throwError("The divisor option 'divisorWhenUnfocused' is invalid ; it should be a positive number higher than one, preferably an integer, [" + s.divisorWhenUnfocused + "] given."),
                      d.default.isNull(s.decimalPlacesShownOnBlur) ||
                        u.test(s.decimalPlacesShownOnBlur) ||
                        d.default.throwError("The number of decimals shown when unfocused option 'decimalPlacesShownOnBlur' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesShownOnBlur + "] given."),
                      d.default.isNull(s.symbolWhenUnfocused) ||
                        d.default.isString(s.symbolWhenUnfocused) ||
                        d.default.throwError("The symbol to show when unfocused option 'symbolWhenUnfocused' is invalid ; it should be a string, [" + s.symbolWhenUnfocused + "] given."),
                      d.default.isTrueOrFalseString(s.saveValueToSessionStorage) ||
                        d.default.isBoolean(s.saveValueToSessionStorage) ||
                        d.default.throwError("The save to session storage option 'saveValueToSessionStorage' is invalid ; it should be either 'false' or 'true', [" + s.saveValueToSessionStorage + "] given."),
                      d.default.isInArray(s.onInvalidPaste, [e.options.onInvalidPaste.error, e.options.onInvalidPaste.ignore, e.options.onInvalidPaste.clamp, e.options.onInvalidPaste.truncate, e.options.onInvalidPaste.replace]) ||
                        d.default.throwError("The paste behavior option 'onInvalidPaste' is invalid ; it should either be 'error', 'ignore', 'clamp', 'truncate' or 'replace' (cf. documentation), [" + s.onInvalidPaste + "] given."),
                      d.default.isInArray(s.roundingMethod, [
                        ...
                        d.default.throwError(
                          "The rounding method option 'roundingMethod' is invalid ; it should either be 'S', 'A', 's', 'a', 'B', 'U', 'D', 'C', 'F', 'N05', 'CHF', 'U05' or 'D05' (cf. documentation), [" + s.roundingMethod + "] given."
                        ),
                      ...
                      ]) || d.default.throwError("The display on empty string option 'emptyInputBehavior' is invalid ; it should either be 'focus', 'press', 'always', 'zero' or 'null', [" + s.emptyInputBehavior + "] given."),
                      s.emptyInputBehavior === e.options.emptyInputBehavior.zero &&
                        (s.minimumValue > 0 || s.maximumValue < 0) &&
                        d.default.throwError("The 'emptyInputBehavior' option is set to 'zero', but this value is outside of the range defined by 'minimumValue' and 'maximumValue' [" + s.minimumValue + ", " + s.maximumValue + "]."),
                      d.default.isTrueOrFalseString(s.eventBubbles) ||
                        d.default.isBoolean(s.eventBubbles) ||
                        d.default.throwError("The event bubbles option 'eventBubbles' is invalid ; it should be either 'true' or 'false', [" + s.eventBubbles + "] given."),
                      d.default.isTrueOrFalseString(s.eventIsCancelable) ||
                        d.default.isBoolean(s.eventIsCancelable) ||
                        d.default.throwError("The event is cancelable option 'eventIsCancelable' is invalid ; it should be either 'true' or 'false', [" + s.eventIsCancelable + "] given."),
                      d.default.isInArray(s.leadingZero, [e.options.leadingZero.allow, e.options.leadingZero.deny, e.options.leadingZero.keep]) ||
                        d.default.throwError("The leading zero behavior option 'leadingZero' is invalid ; it should either be 'allow', 'deny' or 'keep', [" + s.leadingZero + "] given."),
                      d.default.isTrueOrFalseString(s.formatOnPageLoad) ||
                        d.default.isBoolean(s.formatOnPageLoad) ||
                        d.default.throwError("The format on initialization option 'formatOnPageLoad' is invalid ; it should be either 'false' or 'true', [" + s.formatOnPageLoad + "] given."),
                      (u.test(s.historySize) && 0 !== s.historySize) || d.default.throwError("The history size option 'historySize' is invalid ; it should be a positive integer, [" + s.historySize + "] given."),
                      d.default.isTrueOrFalseString(s.selectNumberOnly) ||
                        d.default.isBoolean(s.selectNumberOnly) ||
                        d.default.throwError("The select number only option 'selectNumberOnly' is invalid ; it should be either 'false' or 'true', [" + s.selectNumberOnly + "] given."),
                      d.default.isTrueOrFalseString(s.selectOnFocus) ||
                        d.default.isBoolean(s.selectOnFocus) ||
                        d.default.throwError("The select on focus option 'selectOnFocus' is invalid ; it should be either 'false' or 'true', [" + s.selectOnFocus + "] given."),
                      d.default.isNull(s.defaultValueOverride) ||
                        "" === s.defaultValueOverride ||
                        h.test(s.defaultValueOverride) ||
                        d.default.throwError("The unformatted default value option 'defaultValueOverride' is invalid ; it should be a string that represents a positive or negative number, [" + s.defaultValueOverride + "] given."),
                      d.default.isTrueOrFalseString(s.unformatOnSubmit) ||
                        d.default.isBoolean(s.unformatOnSubmit) ||
                        d.default.throwError("The remove formatting on submit option 'unformatOnSubmit' is invalid ; it should be either 'false' or 'true', [" + s.unformatOnSubmit + "] given."),
                      d.default.isNull(s.valuesToStrings) ||
                        d.default.isObject(s.valuesToStrings) ||
                        d.default.throwError("The option 'valuesToStrings' is invalid ; it should be an object, ideally with 'key -> value' entries, [" + s.valuesToStrings + "] given."),
                      d.default.isNull(s.outputFormat) ||
                        ...
                        d.default.throwError("The custom locale format option 'outputFormat' is invalid ; it should either be null, 'string', 'number', '.', '-.', ',', '-,', '.-' or ',-', [" + s.outputFormat + "] given."),
                      d.default.isTrueOrFalseString(s.isCancellable) ||
                        d.default.isBoolean(s.isCancellable) ||
                        d.default.throwError("The cancellable behavior option 'isCancellable' is invalid ; it should be either 'false' or 'true', [" + s.isCancellable + "] given."),
                      d.default.isTrueOrFalseString(s.modifyValueOnWheel) ||
                        d.default.isBoolean(s.modifyValueOnWheel) ||
                        d.default.throwError("The increment/decrement on mouse wheel option 'modifyValueOnWheel' is invalid ; it should be either 'false' or 'true', [" + s.modifyValueOnWheel + "] given."),
                      d.default.isTrueOrFalseString(s.watchExternalChanges) ||
                        d.default.isBoolean(s.watchExternalChanges) ||
                        d.default.throwError("The option 'watchExternalChanges' is invalid ; it should be either 'false' or 'true', [" + s.watchExternalChanges + "] given."),
                      d.default.isInArray(s.wheelOn, [e.options.wheelOn.focus, e.options.wheelOn.hover]) ||
                        d.default.throwError("The wheel behavior option 'wheelOn' is invalid ; it should either be 'focus' or 'hover', [" + s.wheelOn + "] given."),
                      ((!d.default.isString(s.wheelStep) && !d.default.isNumber(s.wheelStep)) || ("progressive" !== s.wheelStep && !m.test(s.wheelStep)) || 0 === Number(s.wheelStep)) &&
                        d.default.throwError(
                          "The wheel step value option 'wheelStep' is invalid ; it should either be the string 'progressive', or a number or a string that represents a positive number (excluding zero), [" + s.wheelStep + "] given."
                        ),
                      d.default.isInArray(s.serializeSpaces, [e.options.serializeSpaces.plus, e.options.serializeSpaces.percent]) ||
                        d.default.throwError("The space replacement character option 'serializeSpaces' is invalid ; it should either be '+' or '%20', [" + s.serializeSpaces + "] given."),
                      d.default.isTrueOrFalseString(s.noEventListeners) ||
                        d.default.isBoolean(s.noEventListeners) ||
                        d.default.throwError("The option 'noEventListeners' that prevent the creation of event listeners is invalid ; it should be either 'false' or 'true', [" + s.noEventListeners + "] given."),
                      d.default.isNull(s.styleRules) ||
                        (d.default.isObject(s.styleRules) && (s.styleRules.hasOwnProperty("positive") || s.styleRules.hasOwnProperty("negative") || s.styleRules.hasOwnProperty("ranges") || s.styleRules.hasOwnProperty("userDefined"))) ||
                        d.default.throwError("The option 'styleRules' is invalid ; it should be a correctly structured object, with one or more 'positive', 'negative', 'ranges' or 'userDefined' attributes, [" + s.styleRules + "] given."),
                      d.default.isNull(s.styleRules) ||
                      ...
                      ((d.default.isNull(s.rawValueDivisor) || m.test(s.rawValueDivisor)) && 0 !== s.rawValueDivisor && "0" !== s.rawValueDivisor && 1 !== s.rawValueDivisor && "1" !== s.rawValueDivisor) ||
                        d.default.throwError("The raw value divisor option 'rawValueDivisor' is invalid ; it should be a positive number higher than one, preferably an integer, [" + s.rawValueDivisor + "] given."),
                      d.default.isTrueOrFalseString(s.readOnly) || d.default.isBoolean(s.readOnly) || d.default.throwError("The option 'readOnly' is invalid ; it should be either 'false' or 'true', [" + s.readOnly + "] given."),
                      d.default.isTrueOrFalseString(s.unformatOnHover) ||
                        d.default.isBoolean(s.unformatOnHover) ||
                        d.default.throwError("The option 'unformatOnHover' is invalid ; it should be either 'false' or 'true', [" + s.unformatOnHover + "] given."),
                      d.default.isTrueOrFalseString(s.failOnUnknownOption) ||
                        d.default.isBoolean(s.failOnUnknownOption) ||
                        d.default.throwError("The debug option 'failOnUnknownOption' is invalid ; it should be either 'false' or 'true', [" + s.failOnUnknownOption + "] given."),
                      d.default.isTrueOrFalseString(s.createLocalList) ||
                        d.default.isBoolean(s.createLocalList) ||
                        d.default.throwError("The debug option 'createLocalList' is invalid ; it should be either 'false' or 'true', [" + s.createLocalList + "] given.");
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    var i = void 0;
                    (i = d.default.isElement(t) ? d.default.getElementValue(t) : t),
                      d.default.isString(i) || d.default.isNumber(i) || d.default.throwError('The value "' + i + '" being "set" is not numeric and therefore cannot be used appropriately.');
                    ...
                    return (
                      (f && v) ||
                        (this._triggerEvent(e.events.formatted, document, { oldValue: null, newValue: null, oldRawValue: null, newRawValue: null, isPristine: null, error: "Range test failed", aNElement: null }),
                        d.default.throwError("The value [" + h + "] being set falls outside of the minimumValue [" + u.minimumValue + "] and maximumValue [" + u.maximumValue + "] range set for this element")),
                      u.valuesToStrings && this._checkValuesToStringsSettings(i, u)
                        ? u.valuesToStrings[i]
                        : (this._correctNegativePositiveSignPlacementOption(u),
                          this._calculateDecimalPlacesOnInit(u),
                          d.default.isUndefinedOrNullOrEmpty(u.rawValueDivisor) || 0 === u.rawValueDivisor || "" === h || null === h || (h *= u.rawValueDivisor),
                          (h = this._roundFormattedValueShownOnFocus(h, u)),
                          (h = this._modifyNegativeSignAndDecimalCharacterForFormattedValue(h, u)),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (d.default.isNegative(t, l.negativeSignCharacter)) (l.isNegativeSignAllowed = !0), (l.isPositiveSignAllowed = !1);
                      ...
                      (l.firstBracket = c[0]),
                        (l.lastBracket = c[1]),
                        t.charAt(0) === l.firstBracket && t.charAt(t.length - 1) === l.lastBracket && ((l.isNegativeSignAllowed = !0), (l.isPositiveSignAllowed = !1), (t = this._removeBrackets(t, l, !1)));
                    }
                    return (
                      ...
                      new RegExp("[^+-0123456789.]", "gi").test(t)
                        ...
                        : (this._correctNegativePositiveSignPlacementOption(l),
                          l.decimalPlacesRawValue ? (l.originalDecimalPlacesRawValue = l.decimalPlacesRawValue) : (l.originalDecimalPlacesRawValue = l.decimalPlaces),
                          this._calculateDecimalPlacesOnInit(l),
                          d.default.isUndefinedOrNullOrEmpty(l.rawValueDivisor) || 0 === l.rawValueDivisor || "" === t || null === t || (t /= l.rawValueDivisor),
                  ...
                  value: function (t, i, n, a) {
                    ...
                    if (((t = s ? [s[1], s[2], s[3]].join("") : ""), i.leadingZero === e.options.leadingZero.allow || i.leadingZero === e.options.leadingZero.keep)) {
                      var o = "",
                        ...
                        h = u[1],
                        m = c;
                      d.default.contains(m, i.negativeSignCharacter) && ((o = i.negativeSignCharacter), (m = m.replace(i.negativeSignCharacter, ""))),
                        "" === o && m.length > i.mIntPos && "0" === m.charAt(0) && (m = m.slice(1)),
                        "" !== o && m.length > i.mIntNeg && "0" === m.charAt(0) && (m = m.slice(1)),
                        (t = "" + o + m + (d.default.isUndefined(h) ? "" : i.decimalCharacter + h));
                    }
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    var i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
                      n = void 0;
                    return (
                      d.default.isNull(t.negativeBracketsTypeOnBlur) || e.charAt(0) !== t.firstBracket
                        ? (n = e)
                        : ((n = e.replace(t.firstBracket, "")),
                          (n = n.replace(t.lastBracket, "")),
                          i ? ((n = n.replace(t.currencySymbol, "")), (n = this._mergeCurrencySignNegativePositiveSignAndValue(n, t, !0, !1))) : (n = "" + t.negativeSignCharacter + n)),
                      n
                    );
                  },
                },
                {
                  ...
                  value: function (t, i) {
                    (t = this._removeBrackets(t, i, !1)),
                      (t = this._normalizeCurrencySuffixAndNegativeSignCharacters(t, i)),
                      (t = t.replace(new RegExp("[" + i.digitGroupSeparator + "]", "g"), "")),
                      "." !== i.decimalCharacter && (t = t.replace(i.decimalCharacter, ".")),
                      d.default.isNegative(t) && t.lastIndexOf("-") === t.length - 1 && ((t = t.replace("-", "")), (t = "-" + t)),
                ...
                },
                {
                  ...
                  value: function (t, i, n) {
                    return i.emptyInputBehavior === e.options.emptyInputBehavior.always || n
                      ? i.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.left
                ...
                },
                {
                  ...
                  value: function (t, i, n, a) {
                    var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : null,
                      o = void 0;
                    if (
                      ((o = d.default.isNull(s) ? d.default.isNegative(t, i.negativeSignCharacter) || d.default.isNegativeWithBrackets(t, i.firstBracket, i.lastBracket) : s < 0),
                    ...
                    if ("" !== i.digitGroupSeparator) for (; u.test(m); ) m = m.replace(u, "$1" + i.digitGroupSeparator + "$2");
                    var p = void 0;
                    (p = n ? i.decimalPlacesShownOnFocus : i.decimalPlacesShownOnBlur),
                      0 === p || d.default.isUndefined(g) ? (t = m) : (g.length > p && (g = g.substring(0, p)), (t = "" + m + i.decimalCharacter + g)),
                      (t = e._mergeCurrencySignNegativePositiveSignAndValue(t, i, o, l)),
                      d.default.isNull(s) && (s = a),
                      null !== i.negativeBracketsTypeOnBlur && (s < 0 || d.default.isNegativeStrict(t, i.negativeSignCharacter)) && (t = this._toggleNegativeBracket(t, i, n));
                ...
                },
                {
                  ...
                  value: function (t, i) {
                    var n = "";
                    return (
                      d.default.isNegativeStrict(t, "-") && ((n = "-"), (t = t.replace("-", ""))),
                      t.match(/^\d/) || (t = "0" + t),
                      0 === Number(t) && (n = ""),
                ...
                },
                {
                  ...
                  value: function (t, i, n, a) {
                    return (
                      ...
                      (5 === t && i.roundingMethod === e.options.roundingMethod.halfEvenBankersRounding && 1 === a) ||
                ...
                },
                {
                  ...
                  value: function (t) {
                    if (d.default.isNull(t.negativePositiveSignPlacement))
                      if (d.default.isUndefined(t) || !d.default.isUndefinedOrNullOrEmpty(t.negativePositiveSignPlacement) || d.default.isUndefinedOrNullOrEmpty(t.currencySymbol))
                ...
                },
                {
                  ...
                  value: function (t) {
                    return d.default.isNull(t)
                      ? null
                      : (!d.default.isUndefinedOrNullOrEmpty(t.caretPositionOnFocus) && d.default.isUndefinedOrNullOrEmpty(t.selectOnFocus) && (t.selectOnFocus = e.options.selectOnFocus.doNotSelect),
                        d.default.isUndefinedOrNullOrEmpty(t.caretPositionOnFocus) &&
                  ...
                  value: function (t) {
                    ...
                    if (n || "decimalPlacesRawValue" in t || "decimalPlacesShownOnFocus" in t || "decimalPlacesShownOnBlur" in t || "rawValueDivisor" in t) {
                      n
                        ...
                        : (d.default.isUndefined(t.decimalPlacesShownOnFocus) && (t.decimalPlacesShownOnFocus = i.decimalPlacesShownOnFocus),
                          d.default.isUndefined(t.decimalPlacesShownOnBlur) && (t.decimalPlacesShownOnBlur = i.decimalPlacesShownOnBlur));
                      var a = 0;
                      t.rawValueDivisor && t.rawValueDivisor !== e.options.rawValueDivisor.none && (a = String(t.rawValueDivisor).length - 1) < 0 && (a = 0),
                        t.decimalPlaces || t.decimalPlacesRawValue
                          ? (t.decimalPlacesRawValue = Math.max(Math.max(t.decimalPlacesShownOnBlur, t.decimalPlacesShownOnFocus) + a, Number(t.decimalPlacesRawValue) + a))
                          : (t.decimalPlacesRawValue = Math.max(Math.max(t.decimalPlacesShownOnBlur, t.decimalPlacesShownOnFocus) + a, Number(i.originalDecimalPlacesRawValue) + a));
                    }
                  },
                },
                {
                  ...
                  value: function (t, i) {
                    var n = void 0;
                    (n = t.negativeSignCharacter !== e.options.negativeSignCharacter.hyphen ? "([-\\" + t.negativeSignCharacter + "]?)" : "(-?)"),
                      (i.aNegRegAutoStrip = n),
                      (t.allowedAutoStrip = new RegExp("[^-0123456789\\" + t.decimalCharacter + "]", "g")),
                      (t.numRegAutoStrip = new RegExp(n + "(?:\\" + t.decimalCharacter + "?([0-9]+\\" + t.decimalCharacter + "[0-9]+)|([0-9]*(?:\\" + t.decimalCharacter + "[0-9]*)?))")),
                      (t.stripReg = new RegExp("^" + i.aNegRegAutoStrip + "0*([0-9])"));
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    for (var i in e)
                      if (e.hasOwnProperty(i)) {
                        if (!0 === t[i]) continue;
                        t.hasOwnProperty(i)
                          ? (d.default.warning("You are using the deprecated option name '" + i + "'. Please use '" + t[i] + "' instead from now on. The old option name will be dropped very soon™.", !0), (e[t[i]] = e[i]), delete e[i])
                        ...
                        if (e.name && !e.disabled && -1 === ["file", "reset", "submit", "button"].indexOf(e.type))
                          if ("select-multiple" === e.type)
                            Array.prototype.slice.call(e.options).forEach(function (i) {
                              i.selected && (t ? r.push({ name: e.name, value: i.value }) : r.push(encodeURIComponent(e.name) + "=" + encodeURIComponent(i.value)));
                            });
                            ...
                            d.default.isUndefined(a) && d.default.throwError("This error should never be hit. If it has, something really wrong happened!"),
                              t ? r.push({ name: e.name, value: a }) : r.push(encodeURIComponent(e.name) + "=" + encodeURIComponent(a));
                          }
                      });
                    var o = void 0;
            ...
            l(e, null, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return /trident/i.test(i[1])
                    ? ((t = /\brv[ :]+(\d+)/g.exec(e) || []), { name: "ie", version: t[1] || "" })
              ...
              },
              {
                ...
                value: function (e) {
                  var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : document,
                    ...
                    s = void 0;
                  window.CustomEvent ? (s = new CustomEvent(e, { detail: i, bubbles: n, cancelable: a })) : ((s = document.createEvent("CustomEvent")), s.initCustomEvent(e, n, a, { detail: i })), t.dispatchEvent(s);
                },
              },
              {
                key: "parseStr",
                value: function (e) {
                  ...
                  if (
                    ...
                    i > -1 && (e = e.replace(".", "")),
                    i < 0 && (i = e.length),
                    (n = -1 === e.search(/[1-9]/i) ? e.length : e.search(/[1-9]/i)),
                    (a = e.length),
                    n === a)
                  )
                    (t.e = 0), (t.c = [0]);
              ...
              },
              {
                ...
                value: function (e, t) {
                  ...
                  for (a = -1, r = i.length, o = n.length, s = r < o ? r : o, a += 1; a < s; a += 1) if (i[a] !== n[a]) return (i[a] > n[a]) ^ l ? 1 : -1;
      ...
      Object.defineProperty(a.default, "options", {
        get: function () {
          return {
            ...
            digitGroupSeparator: { comma: ",", dot: ".", normalSpace: " ", thinSpace: " ", narrowNoBreakSpace: " ", noBreakSpace: " ", noSeparator: "", apostrophe: "'", arabicThousandsSeparator: "٬", dotAbove: "˙" },
            divisorWhenUnfocused: { none: null, percentage: 100, permille: 1e3, basisPoint: 1e4 },
            emptyInputBehavior: { null: "null", focus: "focus", press: "press", always: "always", zero: "zero" },
            ...
            maximumValue: { tenTrillions: "9999999999999.99", tenTrillionsNoDecimals: "9999999999999", oneBillion: "999999999.99", zero: "0" },
            minimumValue: { tenTrillions: "-9999999999999.99", tenTrillionsNoDecimals: "-9999999999999", oneBillion: "-999999999.99", zero: "0" },
        ...
        Object.defineProperty(s.default, "predefinedOptions", {
          get: function () {
            return {
              ...
              dotDecimalCharCommaSeparator: { digitGroupSeparator: s.default.options.digitGroupSeparator.comma, decimalCharacter: s.default.options.decimalCharacter.dot },
              ...
              integerPos: { minimumValue: s.default.options.minimumValue.zero, decimalPlaces: 0 },
              integerNeg: { maximumValue: s.default.options.maximumValue.zero, decimalPlaces: 0 },
              float: { allowDecimalPadding: s.default.options.allowDecimalPadding.never },
              floatPos: { allowDecimalPadding: s.default.options.allowDecimalPadding.never, minimumValue: s.default.options.minimumValue.zero, maximumValue: s.default.options.maximumValue.tenTrillions },
              floatNeg: { allowDecimalPadding: s.default.options.allowDecimalPadding.never, minimumValue: s.default.options.minimumValue.tenTrillions, maximumValue: s.default.options.maximumValue.zero },
              numeric: { digitGroupSeparator: s.default.options.digitGroupSeparator.noSeparator, decimalCharacter: s.default.options.decimalCharacter.dot, currencySymbol: s.default.options.currencySymbol.none },
              numericPos: {
