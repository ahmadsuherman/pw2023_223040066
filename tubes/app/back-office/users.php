            ...
            <div class="row">
                ...
                <div class="col m-auto">
                    <div class="float-right">
                        <a href="dashboard.php?menu=add-users" class="btn btn-primary"> <i class="fa fa-plus-circle mr-1"></i> Buat Baru</a>  
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="example1" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>ahmad.223040066@mail.unpas.ac.id</td> 
                                        <td>+62 8123454321</td>
                                        <td>superadmin</td>  
                                        <td><span class='badge badge-primary'>Aktif</span></td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="dashboard.php?menu=detail-users&id=1" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fas fa-fw fa-eye"></i></a>
                                                <a href="dashboard.php?menu=edit-users&id=1" class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-fw fa-edit"></i></a>
                                                <button href="javascript:;" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="Non Aktifkan"><i class="fas fa-fw fa-times" onclick="updateStatus(1, 'Ahmad Suherman')"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>jhondoe</td>
                                        <td>Jhon Doe</td>  
                                        <td>jhon.doe@gmai.com</td> 
                                        <td>+62 82134567890</td>
                                        <td>guest</td>  
                                        <td><span class='badge badge-primary'>Aktif</span></td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="dashboard.php?menu=detail-users&id=2" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fas fa-fw fa-eye"></i></a>
                                                <a href="dashboard.php?menu=edit-users&id=2" class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-fw fa-edit"></i></a>
                                                <button href="javascript:;" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="Non Aktifkan"><i class="fas fa-fw fa-times" onclick="updateStatus(2, 'Jhon Doe')"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>alex_jhon</td>
                                        <td>Alex Jhon</td>  
                                        <td>alexjhon123@gmai.com</td> 
                                        <td>+62 87678901234</td>
                                        <td>guest</td>  
                                        <td><span class='badge badge-danger'>Tidak Aktif</span></td>
                                        <td class="text-center">
                                            <div class="btn-group btn-group-sm">
                                                <a href="dashboard.php?menu=detail-users&id=3" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fas fa-fw fa-eye"></i></a>
                                                <a href="dashboard.php?menu=edit-users&id=3" class="btn btn-outline-info" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-fw fa-edit"></i></a>
                                                <button href="javascript:;" class="btn btn-outline-danger" data-toggle="tooltip" data-placement="top" title="Non Aktifkan"><i class="fas fa-fw fa-times" onclick="updateStatus(3, 'Alex Jhon')"></i></button>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
